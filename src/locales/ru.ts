...
export const ru: Messages = {
  ...
  help: `Бросай кубики как никто другой — полная ролевая нотация: оставить/отбросить, взрывающиеся кубики, перебросы, пулы кубиков и проверки.
...
/pick [варианты] — выбор наугад (бета, сокращение: /p)
/help — эта справка
...
<code>1d20+7 vs 15</code> — проверка против сложности, степени успеха Pathfinder 2e
...
<b>Выбор</b>
<code>/pick Патруль гоблинов | Пустая комната | Сокровищница</code> — один вариант наугад
<code>/pick Прокрасться, Договориться «Что дальше?»</code> — запятые и подпись в кавычках
Вставь варианты по одному на строку, чтобы бросить по случайной таблице.
