...
export const be: Messages = {
  ...
  pick: {
    usage: 'Патрэбна прынамсі два варыянты — /pick Камень | Нажніцы | Папера',
    tooMany: 'Занадта шмат варыянтаў — не больш за 100.',
    spaceSplit: 'Падзелена па прабелах — выкарыстоўвай , ці | для цэлых фраз.',
  },
...
/pick [варыянты] — выбар наўздагад (скарот: /p, бета)
/help — гэтая даведка
...
<b>Выбар</b>
<code>/pick Камень | Нажніцы | Папера</code> — адзін варыянт наўздагад
<code>/pick Аня, Барыс, Вера</code> — коскі таксама працуюць
<code>/pick поўнач поўдзень усход захад</code> — асобныя словы можна без падзельніка
<code>/pick Меч | Лук "Якая зброя?"</code> — назаві выбар
Устаў спіс асобнымі радкамі, каб выцягнуць радок з табліцы.
...
Паспрабуй натацыю ў ${playground('пясочніцы')} або адкрый ${reference('поўны даведнік')}.`,
  ...
  commands: [
    ...
    { command: 'pick', description: 'Выбар наўздагад — /pick Камень | Нажніцы | Папера' },
