...
Паспрабуй натацыю ў ${playground('пясочніцы')} або адкрый ${reference('поўны даведнік')}.`,
  ...
  shortDescription:
    'Ролевыя кубікі з поўнай натацыяй — захаванне/скід, выбуховыя кубікі, пулы поспехаў.',

  description:
    'Кідай кубікі як ніхто іншы. Поўная ролевая натацыя: захаванне/скід, выбуховыя кубікі, перакіды, пулы поспехаў і праверкі супраць складанасці. Выкарыстоўвай /roll для сумы, /full для разбору па кубіках або напішы @rollrobot у любым чаце.',
};
